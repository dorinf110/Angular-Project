...
export class RegisterComponent implements OnInit{
  constructor(private router:Router, private fireService:UserServiceFirestoreService, 
  ...
  register(){
    ...
    let existEmailUser = this.Admins.find((x: { email: string; })=>{
    ...
    this.fireService.saveAdmin(user);
  ...
  ngOnInit(): void {
    ...
    this.Admins=[];  
    data.map(a=>{
     this.Admins.push(a.payload.doc.data());
    })
    })}
}
